...
class UnitreeGo2FlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # self.observations.history.prop_observations.params["num_hist"] = 30
...
@configclass
class UnitreeGo2FlatFTNetEnvCfg(LocomotionVelocityRoughFTNetEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class UnitreeGo2FlatFTNetEnvCfg_PLAY(UnitreeGo2FlatFTNetEnvCfg):
    def __post_init__(self) -> None:
        # post init of parent
        super().__post_init__()
        # self.events.randomize_actuator_faults.params["ratio"] = 1.0
        # self.events.randomize_actuator_faults.params["failure_range"] = (0.0, 0.0)
...
@configclass
class UnitreeGo2FlatGCNEnvCfg(LocomotionVelocityRoughGCNEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

        self.observations.history.prop_observations.params["num_hist"] = 5
...
@configclass
class UnitreeGo2FlatGCNEnvCfg_PLAY(UnitreeGo2FlatGCNEnvCfg):
    def __post_init__(self) -> None:
        # post init of parent
        super().__post_init__()
        self.events.randomize_actuator_faults.params["severe_fault_prob"] = 1.0
        self.events.randomize_actuator_faults.params["failure_coef_severe"] = 0.0
        self.events.randomize_actuator_faults.params["failure_coef_moderate"] = 0.0
        self.events.randomize_actuator_faults.params["num_faults"] = 1
        self.events.randomize_actuator_faults.interval_range_s=(3.0, 5.0)
        # make a smaller scene for play
        self.scene.num_envs = 50
