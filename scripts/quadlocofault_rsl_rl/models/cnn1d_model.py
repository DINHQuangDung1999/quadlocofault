...
class CNN1DModel(MLPModel):
    """CNN-based neural model for 1D input. 
    Adapted from rsl_rl.models.cnn_model
    """
...
class _TorchCNNModel(nn.Module):
    ...
    def __init__(self, model: CNN1DModel) -> None:
...
class _OnnxCNNModel(nn.Module):
    ...
    def __init__(self, model: CNN1DModel, verbose: bool) -> None:
