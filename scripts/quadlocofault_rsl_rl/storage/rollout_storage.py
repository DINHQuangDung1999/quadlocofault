...
class RolloutStorage:
    class Transition:
        ...
        def __init__(self) -> None:
            ...
            """The privileged applied torque computed after stepping with current action (therefore at current step)."""
    ...
    class Batch:
        ...
        def __init__(
            ...
            applied_torque: TensorDict | None = None,
            ...
            self.applied_torque: torch.Tensor | None = applied_torque
            """Batch of privileged applied torque."""
    ...
    def __init__(
        ...
        # breakpoint()
        self.applied_torque = torch.zeros(num_transitions_per_env, num_envs, *actions_shape, device=self.device)
    ...
    def add_transition(self, transition: Transition) -> None:
        ...
        self.applied_torque[self.step].copy_(transition.applied_torque)
    ...
    def mini_batch_generator(self, num_mini_batches: int, num_epochs: int = 8) -> Generator[Batch, None, None]:
        ...
        applied_torque = self.applied_torque.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield RolloutStorage.Batch(
                    ...
                    applied_torque=applied_torque[batch_idx],
